...
Davidson, T., Warmsley, D., Macy, M., & Weber, I. (2017). **Automated Hate Speech Detection and the Problem of Offensive Language.** _Proceedings of the International AAAI Conference on Web and Social Media, 11_(1), 512–515.

- Paper: https://doi.org/10.1609/icwsm.v11i1.14955
- Dataset access used in this project: https://www.kaggle.com/datasets/mrmorj/hate-speech-and-offensive-language-dataset

### TwitterAAE

Blodgett, S. L., Green, L., & O'Connor, B. (2016). **Demographic Dialectal Variation in Social Media: A Case Study of African-American English.** _Proceedings of the 2016 Conference on Empirical Methods in Natural Language Processing_, 1119–1130.

- Paper: https://aclanthology.org/D16-1120/
- Resource/model page: https://slanglab.cs.umass.edu/TwitterAAE/
...
If this repository is used in academic work, cite the associated MSc thesis and the original DWMW17 and TwitterAAE resources.

A formal thesis citation can be added here once the final institutional bibliographic details and permanent repository URL are available.

---

## Status

This repository is an archival reproducibility package for the final thesis experiments. It is intended to preserve the implemented pipeline, prompts, environment information, aggregate results, and methodological choices used in the study rather than to serve as a production hate-speech moderation system.
